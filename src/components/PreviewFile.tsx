...
const PreviewFile = () => {
  const data =
    getCookie("formData") && JSON.parse(getCookie("formData") as string);
      ...
      >
        ...
        >
          ...
          >
            <Field
              title="Nº fatias:"
              value={data.qtdFatias}
            />
            <Field
              title="Massa do bolo:"
              value={data.massaBolo}
            />
          </Stack>
          ...
          >
            <Field
              title="Valor:"
              value={data.valorBolo}
            />
            <Field
              title="Sinal:"
              value={data.sinalBolo}
            />
            <Field
              title="Saldo:"
              value={data.saldoBolo}
            />
          </Stack>

          <Field
            title="Forma de pagamento:"
            value={data.formaPagamentoBolo}
          />
          ...
          >
            <Field
              ...
              value={data.nomeContatoEvento}
            />
            <Field
              title="Telefone contato do evento:"
              value={data.telefoneContatoEvento}
            />
          </Stack>
        </Box>
      </Box>
